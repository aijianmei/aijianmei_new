...
#define AvatarWidth 150.0f


@interface MyselfViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, VPImageCropperDelegate>
...
- (void)viewDidLoad
{
    ...
    /*
    UITapGestureRecognizer  *tapCgr = [[UITapGestureRecognizer alloc]   initWithTarget:self action:@selector(clickAvtarViewAction:)];
    tapCgr.numberOfTapsRequired=1;
    tapCgr.delegate =self;
    [self.avatarImageView addGestureRecognizer:tapCgr];
    [tapCgr release];
     */
...
- (UIImageView *)portraitImageView {
    if (!_portraitImageView) {
        ...
        CGFloat w = AvatarWidth; CGFloat h = w;
        ...
        //set the borderWidth 
        _portraitImageView.layer.borderWidth = 4.0f;
        _portraitImageView.userInteractionEnabled = YES;
        _portraitImageView.backgroundColor = [UIColor redColor];
